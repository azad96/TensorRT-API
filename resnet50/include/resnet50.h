...
static const char* PROJECT = "Resnet50";
...
namespace Project{
    class Resnet50 {
    public:
        explicit Resnet50(std::string &weight_path, int in_channel, int in_width, int in_height, int output_count, unsigned int batch_size);
        ~Resnet50();
        bool Init();
