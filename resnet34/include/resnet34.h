...
static const char* PROJECT = "Resnet34";
...
namespace Project{
    class Resnet34 {
    public:
        explicit Resnet34(std::string &weight_path, int in_channel, int in_width, int in_height, int output_count, unsigned int batch_size);
        ~Resnet34();
        bool Init();
